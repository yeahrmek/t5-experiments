...
horovodrun --gloo -np $NP python run_finetuning_babilong_reasoning_rmt.py \
        ...
        --model_cls $MODEL_CLS \
        --model_cpt ../runs/curriculum_task/babilong_reasoning/bert-base-cased/constant_with_warmup_adamw_wd1e-03_998-512-{2}seg_mem10_bs32_regular_from_cpt_1-2/run_1/ \
